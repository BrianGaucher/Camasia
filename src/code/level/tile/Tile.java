...
abstract public class Tile {
	 ...
	 public Tile(int id) {
		  ...
		  if ( tiles[id] != null )
				throw new RuntimeException( "Duplicate tile ids!" ); // You cannot have over-lapping ids
	  ...
	  * @param level  The level in the world
	  * @param x      The X-coordinate
	  * @param y      The Y-coordinate
	  */
	 abstract public void render(Screen screen, Level level, int x, int y);
