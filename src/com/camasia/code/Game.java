...
import com.camasia.code.screen.DeadMenu;
import com.camasia.code.screen.LevelTransitionMenu;
...
import com.camasia.code.gfx.SpriteSheet;
import com.camasia.code.level.Level;
import com.camasia.code.level.tile.Tile;
import com.camasia.code.screen.Menu;
import com.camasia.code.screen.TitleMenu;
import com.camasia.code.screen.WonMenu;
...
public class Game extends Canvas implements Runnable {
	...
	private void init() {
		...
		try {
			screen = new Screen(WIDTH, HEIGHT, new SpriteSheet(ImageIO.read(Game.class.getResourceAsStream( "/resources/icons.png" ))));
			lightScreen = new Screen(WIDTH, HEIGHT, new SpriteSheet(ImageIO.read(Game.class.getResourceAsStream( "/resources/icons.png" ))));
		} catch (IOException e) {
			e.printStackTrace();
		}
